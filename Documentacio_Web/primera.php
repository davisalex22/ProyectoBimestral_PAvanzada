...
<iframe src="http://f5a683045a3f.ngrok.io/#/notebook/2FHC8RERZ/paragraph/paragraph_1595798412458_-574222663?asIframe" style="width: 1000px; height: 400px; border: 0px"></iframe>
                </div>
                 <div id="consulta2">
...
z.show(data.where($"etnia" === "2 - Afroecuatoriano")
           ...
           .orderBy("nivel_de_instruccion"))
                    ...
                    <p>En esta consulta primero realizamos un where el cual delimito el dataframe, en este caso lo delimitamos con la 
                     ...
                     <iframe src="http://f5a683045a3f.ngrok.io/#/notebook/2FHC8RERZ/paragraph/paragraph_1595799293852_-456687849?asIframe" style="width: 1000px; height: 400px; border: 0px"></iframe>
                </div>
                <div id="consulta3">
...
<iframe src="http://f5a683045a3f.ngrok.io/#/notebook/2FHC8RERZ/paragraph/paragraph_1595801114971_227048157?asIframe" style="width: 1000px; height: 400px; border: 0px"></iframe>
                </div>
            <div id="consulta10">
